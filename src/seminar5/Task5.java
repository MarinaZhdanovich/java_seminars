...
//            names.put(name, names.get(name) + 1); //если имя есть, names.get(name) по ключу name получаем значение - текущее количество вхождений
//        } else {
//            names.put(name, 1); // если имя не добавлено, добавляем его в HashMap с начальным значением 1
//        }
//    }
